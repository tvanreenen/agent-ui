...
`}strong(e){return`<strong>${e}</strong>`}em(e){return`<em>${e}</em>`}codespan(e){return`<code>${e}</code>`}br(){return"<br>"}del(e){return`<del>${e}</del>`}link(e,t,n){let s=ts(e);if(s===null)return n;e=s;let o='<a href="'+e+'"';return t&&(o+=' title="'+t+'"'),o+=">"+n+"</a>",o}image(e,t,n){let s=ts(e);if(s===null)return n;e=s;let o=`<img src="${e}" alt="${n}"`;return t&&(o+=` title="${t}"`),o+=">",o}text(e){return e}},We=class{strong(e){return e}em(e){return e}codespan(e){return e}del(e){return e}html(e){return e}text(e){return e}link(e,t,n){return""+n}image(e,t,n){return""+n}br(){return""}},J=class r{constructor(e){x(this,"options");x(this,"renderer");x(this,"textRenderer");this.options=e||ge,this.options.renderer=this.options.renderer||new Se,this.renderer=this.options.renderer,this.renderer.options=this.options,this.textRenderer=new We}static parse(e,t){return new r(t).parse(e)}static parseInline(e,t){return new r(t).parseInline(e)}parse(e,t=!0){let n="";for(let s=0;s<e.length;s++){let o=e[s];if(this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[o.type]){let i=o,c=this.options.extensions.renderers[i.type].call({parser:this},i);if(c!==!1||!["space","hr","heading","code","table","blockquote","list","html","paragraph","text"].includes(i.type)){n+=c||"";continue}}switch(o.type){case"space":continue;case"hr":{n+=this.renderer.hr();continue}case"heading":{let i=o;n+=this.renderer.heading(this.parseInline(i.tokens),i.depth,fi(this.parseInline(i.tokens,this.textRenderer)));continue}case"code":{let i=o;n+=this.renderer.code(i.text,i.lang,!!i.escaped);continue}case"table":{let i=o,c="",l="";for(let h=0;h<i.header.length;h++)l+=this.renderer.tablecell(this.parseInline(i.header[h].tokens),{header:!0,align:i.align[h]});c+=this.renderer.tablerow(l);let u="";for(let h=0;h<i.rows.length;h++){let d=i.rows[h];l="";for(let g=0;g<d.length;g++)l+=this.renderer.tablecell(this.parseInline(d[g].tokens),{header:!1,align:i.align[g]});u+=this.renderer.tablerow(l)}n+=this.renderer.table(c,u);continue}case"blockquote":{let i=o,c=this.parse(i.tokens);n+=this.renderer.blockquote(c);continue}case"list":{let i=o,c=i.ordered,l=i.start,u=i.loose,h="";for(let d=0;d<i.items.length;d++){let g=i.items[d],b=g.checked,A=g.task,U="";if(g.task){let G=this.renderer.checkbox(!!b);u?g.tokens.length>0&&g.tokens[0].type==="paragraph"?(g.tokens[0].text=G+" "+g.tokens[0].text,g.tokens[0].tokens&&g.tokens[0].tokens.length>0&&g.tokens[0].tokens[0].type==="text"&&(g.tokens[0].tokens[0].text=G+" "+g.tokens[0].tokens[0].text)):g.tokens.unshift({type:"text",text:G+" "}):U+=G+" "}U+=this.parse(g.tokens,u),h+=this.renderer.listitem(U,A,!!b)}n+=this.renderer.list(h,c,l);continue}case"html":{let i=o;n+=this.renderer.html(i.text,i.block);continue}case"paragraph":{let i=o;n+=this.renderer.paragraph(this.parseInline(i.tokens));continue}case"text":{let i=o,c=i.tokens?this.parseInline(i.tokens):i.text;for(;s+1<e.length&&e[s+1].type==="text";)i=e[++s],c+=`
`+(i.tokens?this.parseInline(i.tokens):i.text);n+=t?this.renderer.paragraph(c):c;continue}default:{let i='Token with "'+o.type+'" type was not found.';if(this.options.silent)return console.error(i),"";throw new Error(i)}}}return n}parseInline(e,t){t=t||this.renderer;let n="";for(let s=0;s<e.length;s++){let o=e[s];if(this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[o.type]){let i=this.options.extensions.renderers[o.type].call({parser:this},o);if(i!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(o.type)){n+=i||"";continue}}switch(o.type){case"escape":{let i=o;n+=t.text(i.text);break}case"html":{let i=o;n+=t.html(i.text);break}case"link":{let i=o;n+=t.link(i.href,i.title,this.parseInline(i.tokens,t));break}case"image":{let i=o;n+=t.image(i.href,i.title,i.text);break}case"strong":{let i=o;n+=t.strong(this.parseInline(i.tokens,t));break}case"em":{let i=o;n+=t.em(this.parseInline(i.tokens,t));break}case"codespan":{let i=o;n+=t.codespan(i.text);break}case"br":{n+=t.br();break}case"del":{let i=o;n+=t.del(this.parseInline(i.tokens,t));break}case"text":{let i=o;n+=t.text(i.text);break}default:{let i='Token with "'+o.type+'" type was not found.';if(this.options.silent)return console.error(i),"";throw new Error(i)}}}return n}},ue=class{constructor(e){x(this,"options");this.options=e||ge}preprocess(e){return e}postprocess(e){return e}processAllTokens(e){return e}};x(ue,"passThroughHooks",new Set(["preprocess","postprocess","processAllTokens"]));var fe,Zt,gs,Gt=class{constructor(...e){Pn(this,fe);x(this,"defaults",Yt());x(this,"options",this.setOptions);x(this,"parse",rt(this,fe,Zt).call(this,Q.lex,J.parse));x(this,"parseInline",rt(this,fe,Zt).call(this,Q.lexInline,J.parseInline));x(this,"Parser",J);x(this,"Renderer",Se);x(this,"TextRenderer",We);x(this,"Lexer",Q);x(this,"Tokenizer",Ee);x(this,"Hooks",ue);this.use(...e)}walkTokens(e,t){let n=[];for(let s of e)switch(n=n.concat(t.call(this,s)),s.type){case"table":{let o=s;for(let i of o.header)n=n.concat(this.walkTokens(i.tokens,t));for(let i of o.rows)for(let c of i)n=n.concat(this.walkTokens(c.tokens,t));break}case"list":{let o=s;n=n.concat(this.walkTokens(o.items,t));break}default:{let o=s;this.defaults.extensions?.childTokens?.[o.type]?this.defaults.extensions.childTokens[o.type].forEach(i=>{let c=o[i].flat(1/0);n=n.concat(this.walkTokens(c,t))}):o.tokens&&(n=n.concat(this.walkTokens(o.tokens,t)))}}return n}use(...e){let t=this.defaults.extensions||{renderers:{},childTokens:{}};return e.forEach(n=>{let s={...n};if(s.async=this.defaults.async||s.async||!1,n.extensions&&(n.extensions.forEach(o=>{if(!o.name)throw new Error("extension name required");if("renderer"in o){let i=t.renderers[o.name];i?t.renderers[o.name]=function(...c){let l=o.renderer.apply(this,c);return l===!1&&(l=i.apply(this,c)),l}:t.renderers[o.name]=o.renderer}if("tokenizer"in o){if(!o.level||o.level!=="block"&&o.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");let i=t[o.level];i?i.unshift(o.tokenizer):t[o.level]=[o.tokenizer],o.start&&(o.level==="block"?t.startBlock?t.startBlock.push(o.start):t.startBlock=[o.start]:o.level==="inline"&&(t.startInline?t.startInline.push(o.start):t.startInline=[o.start]))}"childTokens"in o&&o.childTokens&&(t.childTokens[o.name]=o.childTokens)}),s.extensions=t),n.renderer){let o=this.defaults.renderer||new Se(this.defaults);for(let i in n.renderer){if(!(i in o))throw new Error(`renderer '${i}' does not exist`);if(i==="options")continue;let c=i,l=n.renderer[c],u=o[c];o[c]=(...h)=>{let d=l.apply(o,h);return d===!1&&(d=u.apply(o,h)),d||""}}s.renderer=o}if(n.tokenizer){let o=this.defaults.tokenizer||new Ee(this.defaults);for(let i in n.tokenizer){if(!(i in o))throw new Error(`tokenizer '${i}' does not exist`);if(["options","rules","lexer"].includes(i))continue;let c=i,l=n.tokenizer[c],u=o[c];o[c]=(...h)=>{let d=l.apply(o,h);return d===!1&&(d=u.apply(o,h)),d}}s.tokenizer=o}if(n.hooks){let o=this.defaults.hooks||new ue;for(let i in n.hooks){if(!(i in o))throw new Error(`hook '${i}' does not exist`);if(i==="options")continue;let c=i,l=n.hooks[c],u=o[c];ue.passThroughHooks.has(i)?o[c]=h=>{if(this.defaults.async)return Promise.resolve(l.call(o,h)).then(g=>u.call(o,g));let d=l.call(o,h);return u.call(o,d)}:o[c]=(...h)=>{let d=l.apply(o,h);return d===!1&&(d=u.apply(o,h)),d}}s.hooks=o}if(n.walkTokens){let o=this.defaults.walkTokens,i=n.walkTokens;s.walkTokens=function(c){let l=[];return l.push(i.call(this,c)),o&&(l=l.concat(o.call(this,c))),l}}this.defaults={...this.defaults,...s}}),this}setOptions(e){return this.defaults={...this.defaults,...e},this}lexer(e,t){return Q.lex(e,t??this.defaults)}parser(e,t){return J.parse(e,t??this.defaults)}};fe=new WeakSet,Zt=function(e,t){return(n,s)=>{let o={...s},i={...this.defaults,...o};this.defaults.async===!0&&o.async===!1&&(i.silent||console.warn("marked(): The async option was set to true by an extension. The async: false option sent to parse will be ignored."),i.async=!0);let c=rt(this,fe,gs).call(this,!!i.silent,!!i.async);if(typeof n>"u"||n===null)return c(new Error("marked(): input parameter is undefined or null"));if(typeof n!="string")return c(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(n)+", string expected"));if(i.hooks&&(i.hooks.options=i),i.async)return Promise.resolve(i.hooks?i.hooks.preprocess(n):n).then(l=>e(l,i)).then(l=>i.hooks?i.hooks.processAllTokens(l):l).then(l=>i.walkTokens?Promise.all(this.walkTokens(l,i.walkTokens)).then(()=>l):l).then(l=>t(l,i)).then(l=>i.hooks?i.hooks.postprocess(l):l).catch(c);try{i.hooks&&(n=i.hooks.preprocess(n));let l=e(n,i);i.hooks&&(l=i.hooks.processAllTokens(l)),i.walkTokens&&this.walkTokens(l,i.walkTokens);let u=t(l,i);return i.hooks&&(u=i.hooks.postprocess(u)),u}catch(l){return c(l)}}},gs=function(e,t){return n=>{if(n.message+=`
Please report this to https://github.com/markedjs/marked.`,e){let s="<p>An error occurred:</p><pre>"+F(n.message+"",!0)+"</pre>";return t?Promise.resolve(s):s}if(t)return Promise.reject(n);throw n}};var de=new Gt;function y(r,e){return de.parse(r,e)}y.options=y.setOptions=function(r){return de.setOptions(r),y.defaults=de.defaults,os(y.defaults),y};y.getDefaults=Yt;y.defaults=ge;y.use=function(...r){return de.use(...r),y.defaults=de.defaults,os(y.defaults),y};y.walkTokens=function(r,e){return de.walkTokens(r,e)};y.parseInline=de.parseInline;y.Parser=J;y.parser=J.parse;y.Renderer=Se;y.TextRenderer=We;y.Lexer=Q;y.lexer=Q.lex;y.Tokenizer=Ee;y.Hooks=ue;y.parse=y;var ir=y.options,or=y.setOptions,rr=y.use,ar=y.walkTokens,lr=y.parseInline;var cr=J.parse,pr=Q.lex;var{entries:Es,setPrototypeOf:ms,isFrozen:Wi,getPrototypeOf:ji,getOwnPropertyDescriptor:Gi}=Object,{freeze:P,seal:q,create:Ss}=Object,{apply:rn,construct:an}=typeof Reflect<"u"&&Reflect;P||(P=function(e){return e});q||(q=function(e){return e});rn||(rn=function(e,t,n){return e.apply(t,n)});an||(an=function(e,t){return new e(...t)});var mt=D(Array.prototype.forEach),Zi=D(Array.prototype.lastIndexOf),bs=D(Array.prototype.pop),Ze=D(Array.prototype.push),Yi=D(Array.prototype.splice),xt=D(String.prototype.toLowerCase),en=D(String.prototype.toString),xs=D(String.prototype.match),Ye=D(String.prototype.replace),Xi=D(String.prototype.indexOf),Vi=D(String.prototype.trim),W=D(Object.prototype.hasOwnProperty),N=D(RegExp.prototype.test),Xe=Ki(TypeError);function D(r){return function(e){e instanceof RegExp&&(e.lastIndex=0);for(var t=arguments.length,n=new Array(t>1?t-1:0),s=1;s<t;s++)n[s-1]=arguments[s];return rn(r,e,n)}}function Ki(r){return function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];return an(r,t)}}function k(r,e){let t=arguments.length>2&&arguments[2]!==void 0?arguments[2]:xt;ms&&ms(r,null);let n=e.length;for(;n--;){let s=e[n];if(typeof s=="string"){let o=t(s);o!==s&&(Wi(e)||(e[n]=o),s=o)}r[s]=!0}return r}function Qi(r){for(let e=0;e<r.length;e++)W(r,e)||(r[e]=null);return r}function ee(r){let e=Ss(null);for(let[t,n]of Es(r))W(r,t)&&(Array.isArray(n)?e[t]=Qi(n):n&&typeof n=="object"&&n.constructor===Object?e[t]=ee(n):e[t]=n);return e}function Ve(r,e){for(;r!==null;){let n=Gi(r,e);if(n){if(n.get)return D(n.get);if(typeof n.value=="function")return D(n.value)}r=ji(r)}function t(){return null}return t}var ks=P(["a","abbr","acronym","address","area","article","aside","audio","b","bdi","bdo","big","blink","blockquote","body","br","button","canvas","caption","center","cite","code","col","colgroup","content","data","datalist","dd","decorator","del","details","dfn","dialog","dir","div","dl","dt","element","em","fieldset","figcaption","figure","font","footer","form","h1","h2","h3","h4","h5","h6","head","header","hgroup","hr","html","i","img","input","ins","kbd","label","legend","li","main","map","mark","marquee","menu","menuitem","meter","nav","nobr","ol","optgroup","option","output","p","picture","pre","progress","q","rp","rt","ruby","s","samp","section","select","shadow","small","source","spacer","span","strike","strong","style","sub","summary","sup","table","tbody","td","template","textarea","tfoot","th","thead","time","tr","track","tt","u","ul","var","video","wbr"]),tn=P(["svg","a","altglyph","altglyphdef","altglyphitem","animatecolor","animatemotion","animatetransform","circle","clippath","defs","desc","ellipse","filter","font","g","glyph","glyphref","hkern","image","line","lineargradient","marker","mask","metadata","mpath","path","pattern","polygon","polyline","radialgradient","rect","stop","style","switch","symbol","text","textpath","title","tref","tspan","view","vkern"]),nn=P(["feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feDropShadow","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence"]),Ji=P(["animate","color-profile","cursor","discard","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignobject","hatch","hatchpath","mesh","meshgradient","meshpatch","meshrow","missing-glyph","script","set","solidcolor","unknown","use"]),sn=P(["math","menclose","merror","mfenced","mfrac","mglyph","mi","mlabeledtr","mmultiscripts","mn","mo","mover","mpadded","mphantom","mroot","mrow","ms","mspace","msqrt","mstyle","msub","msup","msubsup","mtable","mtd","mtext","mtr","munder","munderover","mprescripts"]),eo=P(["maction","maligngroup","malignmark","mlongdiv","mscarries","mscarry","msgroup","mstack","msline","msrow","semantics","annotation","annotation-xml","mprescripts","none"]),ys=P(["#text"]),_s=P(["accept","action","align","alt","autocapitalize","autocomplete","autopictureinpicture","autoplay","background","bgcolor","border","capture","cellpadding","cellspacing","checked","cite","class","clear","color","cols","colspan","controls","controlslist","coords","crossorigin","datetime","decoding","default","dir","disabled","disablepictureinpicture","disableremoteplayback","download","draggable","enctype","enterkeyhint","face","for","headers","height","hidden","high","href","hreflang","id","inputmode","integrity","ismap","kind","label","lang","list","loading","loop","low","max","maxlength","media","method","min","minlength","multiple","muted","name","nonce","noshade","novalidate","nowrap","open","optimum","pattern","placeholder","playsinline","popover","popovertarget","popovertargetaction","poster","preload","pubdate","radiogroup","readonly","rel","required","rev","reversed","role","rows","rowspan","spellcheck","scope","selected","shape","size","sizes","span","srclang","start","src","srcset","step","style","summary","tabindex","title","translate","type","usemap","valign","value","width","wrap","xmlns","slot"]),on=P(["accent-height","accumulate","additive","alignment-baseline","amplitude","ascent","attributename","attributetype","azimuth","basefrequency","baseline-shift","begin","bias","by","class","clip","clippathunits","clip-path","clip-rule","color","color-interpolation","color-interpolation-filters","color-profile","color-rendering","cx","cy","d","dx","dy","diffuseconstant","direction","display","divisor","dur","edgemode","elevation","end","exponent","fill","fill-opacity","fill-rule","filter","filterunits","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","fx","fy","g1","g2","glyph-name","glyphref","gradientunits","gradienttransform","height","href","id","image-rendering","in","in2","intercept","k","k1","k2","k3","k4","kerning","keypoints","keysplines","keytimes","lang","lengthadjust","letter-spacing","kernelmatrix","kernelunitlength","lighting-color","local","marker-end","marker-mid","marker-start","markerheight","markerunits","markerwidth","maskcontentunits","maskunits","max","mask","media","method","mode","min","name","numoctaves","offset","operator","opacity","order","orient","orientation","origin","overflow","paint-order","path","pathlength","patterncontentunits","patterntransform","patternunits","points","preservealpha","preserveaspectratio","primitiveunits","r","rx","ry","radius","refx","refy","repeatcount","repeatdur","restart","result","rotate","scale","seed","shape-rendering","slope","specularconstant","specularexponent","spreadmethod","startoffset","stddeviation","stitchtiles","stop-color","stop-opacity","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke","stroke-width","style","surfacescale","systemlanguage","tabindex","tablevalues","targetx","targety","transform","transform-origin","text-anchor","text-decoration","text-rendering","textlength","type","u1","u2","unicode","values","viewbox","visibility","version","vert-adv-y","vert-origin-x","vert-origin-y","width","word-spacing","wrap","writing-mode","xchannelselector","ychannelselector","x","x1","x2","xmlns","y","y1","y2","z","zoomandpan"]),ws=P(["accent","accentunder","align","bevelled","close","columnsalign","columnlines","columnspan","denomalign","depth","dir","display","displaystyle","encoding","fence","frame","height","href","id","largeop","length","linethickness","lspace","lquote","mathbackground","mathcolor","mathsize","mathvariant","maxsize","minsize","movablelimits","notation","numalign","open","rowalign","rowlines","rowspacing","rowspan","rspace","rquote","scriptlevel","scriptminsize","scriptsizemultiplier","selection","separator","separators","stretchy","subscriptshift","supscriptshift","symmetric","voffset","width","xmlns"]),bt=P(["xlink:href","xml:id","xlink:title","xml:space","xmlns:xlink"]),to=q(/\{\{[\w\W]*|[\w\W]*\}\}/gm),no=q(/<%[\w\W]*|[\w\W]*%>/gm),so=q(/\$\{[\w\W]*/gm),io=q(/^data-[\-\w.\u00B7-\uFFFF]+$/),oo=q(/^aria-[\-\w]+$/),$s=q(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),ro=q(/^(?:\w+script|data):/i),ao=q(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),vs=q(/^html$/i),lo=q(/^[a-z][.\w]*(-[.\w]+)+$/i),Ts=Object.freeze({__proto__:null,ARIA_ATTR:oo,ATTR_WHITESPACE:ao,CUSTOM_ELEMENT:lo,DATA_ATTR:io,DOCTYPE_NAME:vs,ERB_EXPR:no,IS_ALLOWED_URI:$s,IS_SCRIPT_OR_DATA:ro,MUSTACHE_EXPR:to,TMPLIT_EXPR:so}),Ke={element:1,attribute:2,text:3,cdataSection:4,entityReference:5,entityNode:6,progressingInstruction:7,comment:8,document:9,documentType:10,documentFragment:11,notation:12},co=function(){return typeof window>"u"?null:window},po=function(e,t){if(typeof e!="object"||typeof e.createPolicy!="function")return null;let n=null,s="data-tt-policy-suffix";t&&t.hasAttribute(s)&&(n=t.getAttribute(s));let o="dompurify"+(n?"#"+n:"");try{return e.createPolicy(o,{createHTML(i){return i},createScriptURL(i){return i}})}catch{return console.warn("TrustedTypes policy "+o+" could not be created."),null}},As=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function Rs(){let r=arguments.length>0&&arguments[0]!==void 0?arguments[0]:co(),e=m=>Rs(m);if(e.version="3.2.6",e.removed=[],!r||!r.document||r.document.nodeType!==Ke.document||!r.Element)return e.isSupported=!1,e;let{document:t}=r,n=t,s=n.currentScript,{DocumentFragment:o,HTMLTemplateElement:i,Node:c,Element:l,NodeFilter:u,NamedNodeMap:h=r.NamedNodeMap||r.MozNamedAttrMap,HTMLFormElement:d,DOMParser:g,trustedTypes:b}=r,A=l.prototype,U=Ve(A,"cloneNode"),G=Ve(A,"remove"),$e=Ve(A,"nextSibling"),Qe=Ve(A,"childNodes"),oe=Ve(A,"parentNode");if(typeof i=="function"){let m=t.createElement("template");m.content&&m.content.ownerDocument&&(t=m.content.ownerDocument)}let S,Z="",{implementation:kt,createNodeIterator:Cs,createDocumentFragment:Ls,getElementsByTagName:Os}=t,{importNode:Ms}=n,I=As();e.isSupported=typeof Es=="function"&&typeof oe=="function"&&kt&&kt.createHTMLDocument!==void 0;let{MUSTACHE_EXPR:yt,ERB_EXPR:_t,TMPLIT_EXPR:wt,DATA_ATTR:Is,ARIA_ATTR:Ns,IS_SCRIPT_OR_DATA:Ps,ATTR_WHITESPACE:cn,CUSTOM_ELEMENT:Ds}=Ts,{IS_ALLOWED_URI:pn}=Ts,$=null,hn=k({},[...ks,...tn,...nn,...sn,...ys]),C=null,un=k({},[..._s,...on,...ws,...bt]),T=Object.seal(Ss(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),ve=null,Tt=null,dn=!0,At=!0,fn=!1,gn=!0,me=!1,Je=!0,re=!1,Et=!1,St=!1,be=!1,et=!1,tt=!1,mn=!0,bn=!1,zs="user-content-",$t=!0,Re=!1,xe={},ke=null,xn=k({},["annotation-xml","audio","colgroup","desc","foreignobject","head","iframe","math","mi","mn","mo","ms","mtext","noembed","noframes","noscript","plaintext","script","style","svg","template","thead","title","video","xmp"]),kn=null,yn=k({},["audio","video","img","source","image","track"]),vt=null,_n=k({},["alt","class","for","id","label","name","pattern","placeholder","role","summary","title","value","style","xmlns"]),nt="http://www.w3.org/1998/Math/MathML",st="http://www.w3.org/2000/svg",Y="http://www.w3.org/1999/xhtml",ye=Y,Rt=!1,Ct=null,Us=k({},[nt,st,Y],en),it=k({},["mi","mo","mn","ms","mtext"]),ot=k({},["annotation-xml"]),Hs=k({},["title","style","font","a","script"]),Ce=null,Bs=["application/xhtml+xml","text/html"],Fs="text/html",v=null,_e=null,qs=t.createElement("form"),wn=function(a){return a instanceof RegExp||a instanceof Function},Lt=function(){let a=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(!(_e&&_e===a)){if((!a||typeof a!="object")&&(a={}),a=ee(a),Ce=Bs.indexOf(a.PARSER_MEDIA_TYPE)===-1?Fs:a.PARSER_MEDIA_TYPE,v=Ce==="application/xhtml+xml"?en:xt,$=W(a,"ALLOWED_TAGS")?k({},a.ALLOWED_TAGS,v):hn,C=W(a,"ALLOWED_ATTR")?k({},a.ALLOWED_ATTR,v):un,Ct=W(a,"ALLOWED_NAMESPACES")?k({},a.ALLOWED_NAMESPACES,en):Us,vt=W(a,"ADD_URI_SAFE_ATTR")?k(ee(_n),a.ADD_URI_SAFE_ATTR,v):_n,kn=W(a,"ADD_DATA_URI_TAGS")?k(ee(yn),a.ADD_DATA_URI_TAGS,v):yn,ke=W(a,"FORBID_CONTENTS")?k({},a.FORBID_CONTENTS,v):xn,ve=W(a,"FORBID_TAGS")?k({},a.FORBID_TAGS,v):ee({}),Tt=W(a,"FORBID_ATTR")?k({},a.FORBID_ATTR,v):ee({}),xe=W(a,"USE_PROFILES")?a.USE_PROFILES:!1,dn=a.ALLOW_ARIA_ATTR!==!1,At=a.ALLOW_DATA_ATTR!==!1,fn=a.ALLOW_UNKNOWN_PROTOCOLS||!1,gn=a.ALLOW_SELF_CLOSE_IN_ATTR!==!1,me=a.SAFE_FOR_TEMPLATES||!1,Je=a.SAFE_FOR_XML!==!1,re=a.WHOLE_DOCUMENT||!1,be=a.RETURN_DOM||!1,et=a.RETURN_DOM_FRAGMENT||!1,tt=a.RETURN_TRUSTED_TYPE||!1,St=a.FORCE_BODY||!1,mn=a.SANITIZE_DOM!==!1,bn=a.SANITIZE_NAMED_PROPS||!1,$t=a.KEEP_CONTENT!==!1,Re=a.IN_PLACE||!1,pn=a.ALLOWED_URI_REGEXP||$s,ye=a.NAMESPACE||Y,it=a.MATHML_TEXT_INTEGRATION_POINTS||it,ot=a.HTML_INTEGRATION_POINTS||ot,T=a.CUSTOM_ELEMENT_HANDLING||{},a.CUSTOM_ELEMENT_HANDLING&&wn(a.CUSTOM_ELEMENT_HANDLING.tagNameCheck)&&(T.tagNameCheck=a.CUSTOM_ELEMENT_HANDLING.tagNameCheck),a.CUSTOM_ELEMENT_HANDLING&&wn(a.CUSTOM_ELEMENT_HANDLING.attributeNameCheck)&&(T.attributeNameCheck=a.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),a.CUSTOM_ELEMENT_HANDLING&&typeof a.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements=="boolean"&&(T.allowCustomizedBuiltInElements=a.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),me&&(At=!1),et&&(be=!0),xe&&($=k({},ys),C=[],xe.html===!0&&(k($,ks),k(C,_s)),xe.svg===!0&&(k($,tn),k(C,on),k(C,bt)),xe.svgFilters===!0&&(k($,nn),k(C,on),k(C,bt)),xe.mathMl===!0&&(k($,sn),k(C,ws),k(C,bt))),a.ADD_TAGS&&($===hn&&($=ee($)),k($,a.ADD_TAGS,v)),a.ADD_ATTR&&(C===un&&(C=ee(C)),k(C,a.ADD_ATTR,v)),a.ADD_URI_SAFE_ATTR&&k(vt,a.ADD_URI_SAFE_ATTR,v),a.FORBID_CONTENTS&&(ke===xn&&(ke=ee(ke)),k(ke,a.FORBID_CONTENTS,v)),$t&&($["#text"]=!0),re&&k($,["html","head","body"]),$.table&&(k($,["tbody"]),delete ve.tbody),a.TRUSTED_TYPES_POLICY){if(typeof a.TRUSTED_TYPES_POLICY.createHTML!="function")throw Xe('TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.');if(typeof a.TRUSTED_TYPES_POLICY.createScriptURL!="function")throw Xe('TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.');S=a.TRUSTED_TYPES_POLICY,Z=S.createHTML("")}else S===void 0&&(S=po(b,s)),S!==null&&typeof Z=="string"&&(Z=S.createHTML(""));P&&P(a),_e=a}},Tn=k({},[...tn,...nn,...Ji]),An=k({},[...sn,...eo]),Ws=function(a){let p=oe(a);(!p||!p.tagName)&&(p={namespaceURI:ye,tagName:"template"});let f=xt(a.tagName),w=xt(p.tagName);return Ct[a.namespaceURI]?a.namespaceURI===st?p.namespaceURI===Y?f==="svg":p.namespaceURI===nt?f==="svg"&&(w==="annotation-xml"||it[w]):!!Tn[f]:a.namespaceURI===nt?p.namespaceURI===Y?f==="math":p.namespaceURI===st?f==="math"&&ot[w]:!!An[f]:a.namespaceURI===Y?p.namespaceURI===st&&!ot[w]||p.namespaceURI===nt&&!it[w]?!1:!An[f]&&(Hs[f]||!Tn[f]):!!(Ce==="application/xhtml+xml"&&Ct[a.namespaceURI]):!1},j=function(a){Ze(e.removed,{element:a});try{oe(a).removeChild(a)}catch{G(a)}},we=function(a,p){try{Ze(e.removed,{attribute:p.getAttributeNode(a),from:p})}catch{Ze(e.removed,{attribute:null,from:p})}if(p.removeAttribute(a),a==="is")if(be||et)try{j(p)}catch{}else try{p.setAttribute(a,"")}catch{}},En=function(a){let p=null,f=null;if(St)a="<remove></remove>"+a;else{let E=xs(a,/^[\r\n\t ]+/);f=E&&E[0]}Ce==="application/xhtml+xml"&&ye===Y&&(a='<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>'+a+"</body></html>");let w=S?S.createHTML(a):a;if(ye===Y)try{p=new g().parseFromString(w,Ce)}catch{}if(!p||!p.documentElement){p=kt.createDocument(ye,"template",null);try{p.documentElement.innerHTML=Rt?Z:w}catch{}}let L=p.body||p.documentElement;return a&&f&&L.insertBefore(t.createTextNode(f),L.childNodes[0]||null),ye===Y?Os.call(p,re?"html":"body")[0]:re?p.documentElement:L},Sn=function(a){return Cs.call(a.ownerDocument||a,a,u.SHOW_ELEMENT|u.SHOW_COMMENT|u.SHOW_TEXT|u.SHOW_PROCESSING_INSTRUCTION|u.SHOW_CDATA_SECTION,null)},Ot=function(a){return a instanceof d&&(typeof a.nodeName!="string"||typeof a.textContent!="string"||typeof a.removeChild!="function"||!(a.attributes instanceof h)||typeof a.removeAttribute!="function"||typeof a.setAttribute!="function"||typeof a.namespaceURI!="string"||typeof a.insertBefore!="function"||typeof a.hasChildNodes!="function")},$n=function(a){return typeof c=="function"&&a instanceof c};function X(m,a,p){mt(m,f=>{f.call(e,a,p,_e)})}let vn=function(a){let p=null;if(X(I.beforeSanitizeElements,a,null),Ot(a))return j(a),!0;let f=v(a.nodeName);if(X(I.uponSanitizeElement,a,{tagName:f,allowedTags:$}),Je&&a.hasChildNodes()&&!$n(a.firstElementChild)&&N(/<[/\w!]/g,a.innerHTML)&&N(/<[/\w!]/g,a.textContent)||a.nodeType===Ke.progressingInstruction||Je&&a.nodeType===Ke.comment&&N(/<[/\w]/g,a.data))return j(a),!0;if(!$[f]||ve[f]){if(!ve[f]&&Cn(f)&&(T.tagNameCheck instanceof RegExp&&N(T.tagNameCheck,f)||T.tagNameCheck instanceof Function&&T.tagNameCheck(f)))return!1;if($t&&!ke[f]){let w=oe(a)||a.parentNode,L=Qe(a)||a.childNodes;if(L&&w){let E=L.length;for(let z=E-1;z>=0;--z){let V=U(L[z],!0);V.__removalCount=(a.__removalCount||0)+1,w.insertBefore(V,$e(a))}}}return j(a),!0}return a instanceof l&&!Ws(a)||(f==="noscript"||f==="noembed"||f==="noframes")&&N(/<\/no(script|embed|frames)/i,a.innerHTML)?(j(a),!0):(me&&a.nodeType===Ke.text&&(p=a.textContent,mt([yt,_t,wt],w=>{p=Ye(p,w," ")}),a.textContent!==p&&(Ze(e.removed,{element:a.cloneNode()}),a.textContent=p)),X(I.afterSanitizeElements,a,null),!1)},Rn=function(a,p,f){if(mn&&(p==="id"||p==="name")&&(f in t||f in qs))return!1;if(!(At&&!Tt[p]&&N(Is,p))){if(!(dn&&N(Ns,p))){if(!C[p]||Tt[p]){if(!(Cn(a)&&(T.tagNameCheck instanceof RegExp&&N(T.tagNameCheck,a)||T.tagNameCheck instanceof Function&&T.tagNameCheck(a))&&(T.attributeNameCheck instanceof RegExp&&N(T.attributeNameCheck,p)||T.attributeNameCheck instanceof Function&&T.attributeNameCheck(p))||p==="is"&&T.allowCustomizedBuiltInElements&&(T.tagNameCheck instanceof RegExp&&N(T.tagNameCheck,f)||T.tagNameCheck instanceof Function&&T.tagNameCheck(f))))return!1}else if(!vt[p]){if(!N(pn,Ye(f,cn,""))){if(!((p==="src"||p==="xlink:href"||p==="href")&&a!=="script"&&Xi(f,"data:")===0&&kn[a])){if(!(fn&&!N(Ps,Ye(f,cn,"")))){if(f)return!1}}}}}}return!0},Cn=function(a){return a!=="annotation-xml"&&xs(a,Ds)},Ln=function(a){X(I.beforeSanitizeAttributes,a,null);let{attributes:p}=a;if(!p||Ot(a))return;let f={attrName:"",attrValue:"",keepAttr:!0,allowedAttributes:C,forceKeepAttr:void 0},w=p.length;for(;w--;){let L=p[w],{name:E,namespaceURI:z,value:V}=L,Le=v(E),Mt=V,O=E==="value"?Mt:Vi(Mt);if(f.attrName=Le,f.attrValue=O,f.keepAttr=!0,f.forceKeepAttr=void 0,X(I.uponSanitizeAttribute,a,f),O=f.attrValue,bn&&(Le==="id"||Le==="name")&&(we(E,a),O=zs+O),Je&&N(/((--!?|])>)|<\/(style|title)/i,O)){we(E,a);continue}if(f.forceKeepAttr)continue;if(!f.keepAttr){we(E,a);continue}if(!gn&&N(/\/>/i,O)){we(E,a);continue}me&&mt([yt,_t,wt],Mn=>{O=Ye(O,Mn," ")});let On=v(a.nodeName);if(!Rn(On,Le,O)){we(E,a);continue}if(S&&typeof b=="object"&&typeof b.getAttributeType=="function"&&!z)switch(b.getAttributeType(On,Le)){case"TrustedHTML":{O=S.createHTML(O);break}case"TrustedScriptURL":{O=S.createScriptURL(O);break}}if(O!==Mt)try{z?a.setAttributeNS(z,E,O):a.setAttribute(E,O),Ot(a)?j(a):bs(e.removed)}catch{we(E,a)}}X(I.afterSanitizeAttributes,a,null)},js=function m(a){let p=null,f=Sn(a);for(X(I.beforeSanitizeShadowDOM,a,null);p=f.nextNode();)X(I.uponSanitizeShadowNode,p,null),vn(p),Ln(p),p.content instanceof o&&m(p.content);X(I.afterSanitizeShadowDOM,a,null)};return e.sanitize=function(m){let a=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},p=null,f=null,w=null,L=null;if(Rt=!m,Rt&&(m="<!-->"),typeof m!="string"&&!$n(m))if(typeof m.toString=="function"){if(m=m.toString(),typeof m!="string")throw Xe("dirty is not a string, aborting")}else throw Xe("toString is not a function");if(!e.isSupported)return m;if(Et||Lt(a),e.removed=[],typeof m=="string"&&(Re=!1),Re){if(m.nodeName){let V=v(m.nodeName);if(!$[V]||ve[V])throw Xe("root node is forbidden and cannot be sanitized in-place")}}else if(m instanceof c)p=En("<!---->"),f=p.ownerDocument.importNode(m,!0),f.nodeType===Ke.element&&f.nodeName==="BODY"||f.nodeName==="HTML"?p=f:p.appendChild(f);else{if(!be&&!me&&!re&&m.indexOf("<")===-1)return S&&tt?S.createHTML(m):m;if(p=En(m),!p)return be?null:tt?Z:""}p&&St&&j(p.firstChild);let E=Sn(Re?m:p);for(;w=E.nextNode();)vn(w),Ln(w),w.content instanceof o&&js(w.content);if(Re)return m;if(be){if(et)for(L=Ls.call(p.ownerDocument);p.firstChild;)L.appendChild(p.firstChild);else L=p;return(C.shadowroot||C.shadowrootmode)&&(L=Ms.call(n,L,!0)),L}let z=re?p.outerHTML:p.innerHTML;return re&&$["!doctype"]&&p.ownerDocument&&p.ownerDocument.doctype&&p.ownerDocument.doctype.name&&N(vs,p.ownerDocument.doctype.name)&&(z="<!DOCTYPE "+p.ownerDocument.doctype.name+`>
`+z),me&&mt([yt,_t,wt],V=>{z=Ye(z,V," ")}),S&&tt?S.createHTML(z):z},e.setConfig=function(){let m=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};Lt(m),Et=!0},e.clearConfig=function(){_e=null,Et=!1},e.isValidAttribute=function(m,a,p){_e||Lt({});let f=v(m),w=v(a);return Rn(f,w,p)},e.addHook=function(m,a){typeof a=="function"&&Ze(I[m],a)},e.removeHook=function(m,a){if(a!==void 0){let p=Zi(I[m],a);return p===-1?void 0:Yi(I[m],p,1)[0]}return bs(I[m])},e.removeHooks=function(m){I[m]=[]},e.removeAllHooks=function(){I=As()},e}var ln=Rs();var M=class extends se{constructor(){super(...arguments);x(this,"prompts",[]);x(this,"agentName","Agent");x(this,"placeholderText","Ask me anything - I can help with data, actions, and insights");x(this,"iconSvg","");x(this,"iconUrl","");x(this,"messages",[]);x(this,"open",!1);x(this,"panelMode",!1);x(this,"inputFocused",!1);x(this,"loadedIconSvg","");x(this,"isTyping",!1)}setOpen(t){this.open=t,this.requestUpdate(),!t&&this.panelMode&&(this.panelMode=!1,document.body.style.marginRight="0",document.body.style.transition=""),t&&(this.inputFocused=!1),this.updateComplete.then(()=>{let n=this.shadowRoot?.querySelector(".container");n&&(t?n.style.bottom="0":n.style.bottom="")})}setTyping(t){this.isTyping=t,this.requestUpdate()}replaceLastMessage(t){if(this.messages.length===0){this.messages=[{type:"agent",text:t}],this.requestUpdate(),this.updateComplete.then(()=>this._scrollToBottom());return}let n=this.messages[this.messages.length-1];n.type==="agent"?(this.messages=[...this.messages.slice(0,-1),{...n,text:t}],this.requestUpdate(),this.updateComplete.then(()=>this._scrollToBottom())):(this.messages=[...this.messages,{type:"agent",text:t}],this.requestUpdate(),this.updateComplete.then(()=>this._scrollToBottom()))}appendToLastMessage(t){if(this.messages.length===0){this.messages=[{type:"agent",text:t}],this.requestUpdate(),this.updateComplete.then(()=>this._scrollToBottom());return}let n=this.messages[this.messages.length-1];if(n.type==="agent"){let s=n.text+t;this.messages=[...this.messages.slice(0,-1),{...n,text:s}],this.requestUpdate(),this.updateComplete.then(()=>this._scrollToBottom())}else this.messages=[...this.messages,{type:"agent",text:t}],this.requestUpdate(),this.updateComplete.then(()=>this._scrollToBottom())}_scrollToBottom(){let t=this.shadowRoot?.querySelector(".body");t&&(t.scrollTop=t.scrollHeight)}_parseMarkdown(t){try{y.setOptions({breaks:!0,gfm:!0});let n=y.parse(t),s=typeof n=="string"?n:String(n);return this._sanitizeHTML(s)}catch(n){return console.warn("Markdown parsing failed:",n),this._sanitizeText(t)}}_sanitizeText(t){return ln.sanitize(t,{ALLOWED_TAGS:[],ALLOWED_ATTR:[]})}_sanitizeHTML(t){return ln.sanitize(t,{ALLOWED_TAGS:["h1","h2","h3","h4","h5","h6","strong","b","em","i","code","pre","ul","ol","li","a","blockquote","br","p","div"],ALLOWED_ATTR:["href","target","rel","class","id"],ALLOW_DATA_ATTR:!1,KEEP_CONTENT:!0})}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this._handleGlobalKeydown.bind(this)),this._loadIcon()}async _loadIcon(){if(this.iconSvg){this.loadedIconSvg=this.iconSvg;return}if(this.iconUrl)try{let t=await fetch(this.iconUrl);t.ok?this.loadedIconSvg=await t.text():console.warn(`Failed to load icon from URL: ${this.iconUrl}`)}catch(t){console.warn(`Error loading icon from URL: ${this.iconUrl}`,t)}}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this._handleGlobalKeydown.bind(this)),this.panelMode&&(document.body.style.marginRight="0",document.body.style.transition="")}_handleGlobalKeydown(t){if((t.ctrlKey||t.metaKey)&&t.key==="k"){t.preventDefault();let n=this.shadowRoot?.querySelector(".input-field");n&&(n.focus(),this.inputFocused=!0,this.requestUpdate())}t.key==="Escape"&&this.open&&(t.preventDefault(),this.setOpen(!1))}render(){return B`
  ...
  `),H([ie({type:Array})],M.prototype,"prompts",2),H([ie({type:String})],M.prototype,"agentName",2),H([ie({type:String})],M.prototype,"placeholderText",2),H([ie({type:String})],M.prototype,"iconSvg",2),H([ie({type:String})],M.prototype,"iconUrl",2),H([he()],M.prototype,"messages",2),H([he()],M.prototype,"open",2),H([he()],M.prototype,"panelMode",2),H([he()],M.prototype,"inputFocused",2),H([he()],M.prototype,"loadedIconSvg",2),H([he()],M.prototype,"isTyping",2),M=H([Jn("agent-ui")],M);window.AgentUI={init:r=>{let e=document.querySelector("agent-ui");return e||(e=document.createElement("agent-ui"),document.body.appendChild(e)),e.prompts=r.prompts,e.agentName=r.agentName,e.placeholderText=r.placeholderText,r.iconSvg&&(e.iconSvg=r.iconSvg),r.iconUrl&&(e.iconUrl=r.iconUrl),e.requestUpdate(),e}};})();
